/* Instituto Hand Maria — Popup Transparência (JS + HTML)
 * Uso simples no HTML: onclick="openTransparenciaPopup('Relatório 2023')"
 * Uso avançado: openTransparenciaPopup({
 *   item: 'Relatório 2023',
 *   title: 'Transparência — Documento em atualização',
 *   message: 'Estamos preparando os arquivos. Em breve você poderá baixar.',
 *   whatsapp: '5511999999999',
 *   email: 'contato@institutohandmaria.org'
 * })
 */
(function () {
